        ...
        <el-row style="margin-top:20px;" :gutter="20">
            <el-col :span="12">
                <el-card style="width:100%;height:100%">
                    ...
                    <div class="chart-content emotion-chart-content">
                        <div ref="emotionChartRef" style="width:100%;height:370px;"></div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="12">
                <el-card style="width:100%;height:100%;">
                    ...
                    <div class="chart-content consultation-chart-content">
...
.dashboard-container {
    ...
    .chart-content {
      ...
      height: 300px;
      position: relative;
      &.emotion-chart-content,
      &.consultation-chart-content {
        height: auto;
      }
